    ...
    methods: {
        async getBoard() {
            axios.get(`http://localhost:3000/board/${this.index}`,
                ...
                await axios.post(`http://localhost:3000/board/update/${this.index}`, { view: this.board.view + 1 })
                    .then((response) =>
        ...
        deleteBoard() {
            axios.post(`http://localhost:3000/board/delete`, this.board)
                .then((response) => {
        ...
        async goodcount() {
            this.board_count++;
            await axios.post(`http://localhost:3000/board/update/${this.index}`, { count: this.board_count })
                .then((response) =>
                    this.board = response.data
                ).catch((error) => {
                    console.log(error)
