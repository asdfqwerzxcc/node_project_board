      ...
      <table v-if="selected" border="1px" align="center">
        ...
        <tbody>
          ...
          <tr v-for="j in paginatedData" :key="j">
            ...
            <td v-if="j.rank === 1"><img alt="number1" width="40" height="40" src="../assets/icon_ranking1.png"></td>
            <td v-else-if="j.rank === 2"><img alt="number2" width="40" height="40" src="../assets/icon_ranking2.png"></td>
            <td v-else-if="j.rank === 3"><img alt="number3" width="30" height="30" src="../assets/icon_ranking3.png"></td>
            <td v-else>{{ j.rank }} </td>
